...
[2] ICAR-IIGR — Directorate of Groundnut Research
  ...
  // ─── 3. Groundnut 30 days / vegetative / pegging / rainfall query ──────────
  if (
    crop === 'groundnut' &&
